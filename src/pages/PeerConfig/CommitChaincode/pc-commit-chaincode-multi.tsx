...
export const PeerConfigCommitChaincodeMulti: React.FC<DropdownProps> = ({ id }) => {
    ...
    return (
        <div className="relative z-50">
            <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                Select the peers where you want to commit
            </label>
            <div>
                <select className="hidden" id={id}>
                    <option value="orgx-peer1">orgx-peer1</option>
                    <option value="orgy-peer1">orgy-peer1</option>
                    <option value="orgz-peer1">orgz-peer1</option>
                    <option value="orgs-peer1">orgs-peer1</option>
                </select>
