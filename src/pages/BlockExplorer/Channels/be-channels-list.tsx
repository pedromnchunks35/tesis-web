...
export const BlockExplorerChannelsList: React.FC<Props> = ({ result, pageSize, setPageSize, currentPage, setCurrentPage }) => {
        ...
        <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            <div className="flex flex-col">
                ...
                {result.map((obj: any, key: any) => (
                    <div
                        className={`grid grid-cols-3 sm:grid-cols-5 ${key === result.length - 1
                            ? ''
                    ...
                    >
                        ...
                        <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                            <p className="text-black dark:text-white">{obj.numberOfBlocks}</p>
                        </div>
